...
?>
 ...
 <table align="center" >
 <tr><td><textarea id="feedback" name="feedback" style="min-width:500px;min-height:150px;"  onkeydown="manage_count()"   onkeyup="manage_count()" class="input input-large" placeholder="Please provide your valuable feedback to improve our product..."  maxlength="1000" ></textarea></td></tr>
	 ...
	 if($_POST['feedback']!="")
	  {
	    ...
	    $date_time=time_stamp(time());
		mysql_query("insert into feedback_oep set feedback='$_POST[feedback]', username='$uname' date_time='$date_time' ");
